...
# data specifications 
parser.add_argument('--dir_input', type=str, default='../images/Unreal_7500/input/',
                    help='image dataset directory')
parser.add_argument('--dir_mask', type=str, default='../images/Unreal_7500/mask/',
                    help='mask dataset directory')
parser.add_argument('--dir_GT', type=str, default='../images/Unreal_7500/GT/',
                    help='mask dataset directory')
parser.add_argument('--dir_input_val', type=str, default='../images/Unreal_7500/input_val/',
                    help='image dataset directory')
parser.add_argument('--dir_mask_val', type=str, default='../images/Unreal_7500/mask_val/',
                    help='mask dataset directory')
parser.add_argument('--dir_GT_val', type=str, default='../images/Unreal_7500/GT_val/',
                    help='mask dataset directory')
parser.add_argument('--data_train', type=str, default='Unreal7500',
                    help='dataname used for training')
parser.add_argument('--data_test', type=str, default='Unreal7500',
                    help='dataname used for testing')
parser.add_argument('--image_size', type=int, default=512,
                    help='image size used during training')
parser.add_argument('--mask_type', type=str, default='Unreal7500',
...
parser.add_argument('--iterations', type=int, default=105000,
...
parser.add_argument('--save_every', type=int, default=5250,
