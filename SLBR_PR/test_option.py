...
class Options():
    ...
    def __init__(self):
        ...
        parser.add_argument('-c', '--checkpoint', default='checkpoint', type=str, metavar='./result/log_check_point',
                            help='path to save checkpoint (default: checkpoint)')
        parser.add_argument('--resume', default='./checkpoint/350-P-60/model_best.pth.tar', type=str, metavar='PATH',
