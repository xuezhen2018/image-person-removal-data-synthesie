...
class TrainOptions:
    ...
    def __init__(self):
        ...
        parser.add_argument('--input_root', type=str,
                            default='../image/Unreal_BL/input')
        parser.add_argument('--GT_root', type=str,
                            default='../image/Unreal_BL/GT')
        parser.add_argument('--mask_root', type=str,
                            default='../image/Unreal_BL/mask')
        parser.add_argument('--val_input_root', type=str,
                            default='../image/500_3dre/input_val')
        parser.add_argument('--val_GT_root', type=str,
                            default='../image/500_3dre/GT_val')
        parser.add_argument('--val_mask_root', type=str,
                            default='../image/500_3dre/mask_val')

        parser.add_argument('--save_dir', type=str, default='snapshots/CSTDG_BL_3dre')
        ...
        parser.add_argument('--train_iter', type=int, default=35000)
